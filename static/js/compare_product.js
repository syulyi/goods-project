...
//        document.getElementById('selected-image-container-3').style.display = 'block';
    ...
    if (selectedValue === "kbo_samsung_prod_001") {
    ...
    } else if (selectedValue === "kbo_samsung_prod_002") {
        imageElement.src = "/static/image/kbo_samsung_002.png";
        updateProductDescription('2024 프로페셔널 선데이 모자', '42,000원', '삼성라이온즈의 24시즌 프로페셔널 선데이 모자입니다. 일요일 경기가 있을 때마다 착용합니다. 자세한 내용은 하단의 상세 설명을 꼭 확인해 주세요!');
    } else if (selectedValue === "kbo_samsung_prod_003") {
        imageElement.src = "/static/image/kbo_samsung_003.png";
        updateProductDescription('2024 프로페셔널 선데이 모자', '42,000원', '삼성라이온즈의 24시즌 프로페셔널 선데이 모자입니다. 일요일 경기가 있을 때마다 착용합니다. 자세한 내용은 하단의 상세 설명을 꼭 확인해 주세요!');
    } else if (selectedValue === "kbo_samsung_prod_004") {
        imageElement.src = "/static/image/kbo_samsung_004.png";
    } else if (selectedValue === "kbo_samsung_prod_005") {
        imageElement.src = "/static/image/kbo_samsung_005.png";
    } else if (selectedValue === "kbo_samsung_prod_006") {
        imageElement.src = "/static/image/kbo_samsung_006.png";
    } else if (selectedValue === "kbo_nc_prod_001") {
        imageElement.src = "/static/image/kbo_nc_001.png";
    } else if (selectedValue === "kbo_nc_prod_002") {
        imageElement.src = "/static/image/kbo_nc_002.png";
    } else if (selectedValue === "kbo_nc_prod_003") {
        imageElement.src = "/static/image/kbo_nc_003.png";
    } else if (selectedValue === "kbo_nc_prod_004") {
        imageElement.src = "/static/image/kbo_nc_004.png";
    } else if (selectedValue === "kbo_nc_prod_005") {
        imageElement.src = "/static/image/kbo_nc_005.png";
    } else if (selectedValue === "kbo_nc_prod_006") {
        imageElement.src = "/static/image/kbo_nc_006.png";
    }
